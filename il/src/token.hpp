...
namespace token {
    enum class TokenType {
        ...
        // Keywords
        Let, True, False, None, Or, And, If, Else, While, For, Fun, Return, Struct,
    ...
    inline constexpr std::array TOKEN_NAMES {
        ...
        "Let"sv, "True"sv, "False"sv, "None"sv, "Or"sv, "And"sv, "If"sv, "Else"sv, "While"sv, "For"sv, "Fun"sv, "Return"sv, "Struct"sv,
